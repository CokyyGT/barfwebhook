...
local function RunLoop()
    ...
    while Running do
        -- Pasang listener SEBELUM roll biar ga kelewat
        local bonusDetected = FindBonusObject() -- cek kalau udah ada dari sebelumnya
        local bonusTimes = {}
        ...
        -- Cek ulang bonus sekarang kalau masih ada
